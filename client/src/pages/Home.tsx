  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex items-start justify-center overflow-hidden bg-background">
        ...
        >
          <motion.p
            className="text-[10px] font-light tracking-[0.32em] text-white/45 uppercase mb-[265px] md:mb-[285px]"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          <motion.p
            className="text-[22px] md:text-[28px] font-light tracking-wide text-white/90 mb-12 leading-snug"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
